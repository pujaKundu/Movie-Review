...
const Navbar = () => {
  ...
  return (
    <div className="py-5 bg-zinc-900 flex justify-between  top-0 sticky z-20">
      ...
      <div>
        ...
        {showModal && (
          <div
            className="fixed mt-2 w-96 z-100 bg-black bg-opacity-50 flex justify-center items-center overflow-hidden mr-5"
              ...
              <ul className="space-y-4">
                {searchResults.map((movie) => (
                  <Link key={movie.id} href={`/movies/${movie.id}`}>
                    <div className="flex items-center justify-start cursor-pointer hover:bg-zinc-700 rounded p-3">
                      <img
